...
|Vault|Fully functional from user's perspective|Unsafe - memlock is disabled - again do not use for managing real secrets|
|HAProxy|Both HAProxy containers are fully functional|Nothing, code is the same|
